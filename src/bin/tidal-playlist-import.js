...
function login(accountToUse) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield api.test();
            loginSpinner.succeed("Login was successful!");
            return true;
        }
        catch (e) {
            loginSpinner.fail(`Login was not successful: ${e.message}`);
            return false;
        }
    });
}
program
    ...
    .option("-a", "--account", "Account to use")
    ...
    .command("accounts <action> [email] [password]")
    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (action === "set") {
            ...
            const accounts = (yield accountStorage.list()).map(x => x.account);
...
const accountStorage = new AccountStorage_1.AccountStorage();
